          ...
          <form onSubmit={handleLeadSubmit} className="space-y-6 text-left">
            ...
            <div className="pt-8 text-center">
              <button 
                ...
                className="inline-flex items-center justify-center space-x-3 bg-brand-taupe text-brand-ink px-12 py-4 rounded-sm text-xs uppercase tracking-[0.2em] font-medium hover:bg-white transition-colors disabled:opacity-75 cursor-pointer min-w-[220px]"
              >
                {submittingLead ? (
                  <>
